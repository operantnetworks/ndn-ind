...
LOCAL_C_INCLUDES := app/src/ndn-ind/contrib/sqlite3
LOCAL_SRC_FILES := src/ndn-ind/contrib/sqlite3/sqlite3.c
include $(BUILD_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := ndn-ind
LOCAL_C_INCLUDES := \
  app/src/ndn-ind/include app/src/openssl/include \
  app/src/ndn-ind/contrib/sqlite3
LOCAL_SHARED_LIBRARIES := openssl sqlite3
LOCAL_SRC_FILES := \
  src/ndn-ind/contrib/apache/apr_base64.c \
  src/ndn-ind/contrib/murmur-hash/murmur-hash.c \
  src/ndn-ind/src/c/control-parameters_c.c \
  src/ndn-ind/src/c/errors.c \
  src/ndn-ind/src/c/interest_c.c \
  src/ndn-ind/src/c/name_c.c \
  src/ndn-ind/src/c/network-nack_c.c \
  src/ndn-ind/src/c/registration-options.c \
  src/ndn-ind/src/c/encoding/element-reader.c \
  src/ndn-ind/src/c/encoding/tlv-0_2-wire-format_c.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-control-parameters.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-control-response.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-data.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-delegation-set.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-decoder.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-encoder.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-encrypted-content.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-interest.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-key-locator.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-lp-packet.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-name.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-signature-info.c \
  src/ndn-ind/src/c/encoding/tlv/tlv-structure-decoder.c \
  src/ndn-ind/src/c/encrypt/algo/aes-algorithm_c.c \
  src/ndn-ind/src/c/encrypt/algo/des-algorithm_c.c \
  src/ndn-ind/src/c/lp/congestion-mark_c.c \
  src/ndn-ind/src/c/lp/incoming-face-id_c.c \
  src/ndn-ind/src/c/security/ec-private-key.c \
  src/ndn-ind/src/c/security/ec-public-key.c \
  src/ndn-ind/src/c/security/rsa-private-key.c \
  src/ndn-ind/src/c/security/rsa-public-key.c \
  src/ndn-ind/src/c/transport/socket-transport.c \
  src/ndn-ind/src/c/transport/tcp-transport_c.c \
  src/ndn-ind/src/c/util/blob_c.c \
  src/ndn-ind/src/c/util/crypto.c \
  src/ndn-ind/src/c/util/dynamic-uint8-array.c \
  src/ndn-ind/src/c/util/ndn_memory.c \
  src/ndn-ind/src/c/util/ndn_realloc.c \
  src/ndn-ind/src/c/util/time.c \
  src/ndn-ind/src/common.cpp \
  src/ndn-ind/src/control-parameters.cpp \
  src/ndn-ind/src/control-response.cpp \
  src/ndn-ind/src/data.cpp \
  src/ndn-ind/src/delegation-set.cpp \
  src/ndn-ind/src/digest-sha256-signature.cpp \
  src/ndn-ind/src/exclude.cpp \
  src/ndn-ind/src/face.cpp \
  src/ndn-ind/src/generic-signature.cpp \
  src/ndn-ind/src/hmac-with-sha256-signature.cpp \
  src/ndn-ind/src/interest-filter.cpp \
  src/ndn-ind/src/interest.cpp \
  src/ndn-ind/src/key-locator.cpp \
  src/ndn-ind/src/link.cpp \
  src/ndn-ind/src/meta-info.cpp \
  src/ndn-ind/src/name.cpp \
  src/ndn-ind/src/network-nack.cpp \
  src/ndn-ind/src/node.cpp \
  src/ndn-ind/src/signature.cpp \
  src/ndn-ind/src/sha256-with-ecdsa-signature.cpp \
  src/ndn-ind/src/sha256-with-rsa-signature.cpp \
  src/ndn-ind/src/encoding/base64.cpp \
  src/ndn-ind/src/encoding/element-listener.cpp \
  src/ndn-ind/src/encoding/oid.cpp \
  src/ndn-ind/src/encoding/protobuf-tlv.cpp \
  src/ndn-ind/src/encoding/tlv-0_1-wire-format.cpp \
  src/ndn-ind/src/encoding/tlv-0_1_1-wire-format.cpp \
  src/ndn-ind/src/encoding/tlv-0_2-wire-format.cpp \
  src/ndn-ind/src/encoding/tlv-wire-format.cpp \
  src/ndn-ind/src/encoding/wire-format.cpp \
  src/ndn-ind/src/encoding/der/der-exception.cpp \
  src/ndn-ind/src/encoding/der/der-node.cpp \
  src/ndn-ind/src/encrypt/access-manager-v2.cpp \
  src/ndn-ind/src/encrypt/consumer.cpp \
  src/ndn-ind/src/encrypt/consumer-db.cpp \
  src/ndn-ind/src/encrypt/decryptor-v2.cpp \
  src/ndn-ind/src/encrypt/encrypted-content.cpp \
  src/ndn-ind/src/encrypt/encryptor-v2.cpp \
  src/ndn-ind/src/encrypt/group-manager.cpp \
  src/ndn-ind/src/encrypt/group-manager-db.cpp \
  src/ndn-ind/src/encrypt/interval.cpp \
  src/ndn-ind/src/encrypt/producer.cpp \
  src/ndn-ind/src/encrypt/producer-db.cpp \
  src/ndn-ind/src/encrypt/repetitive-interval.cpp \
  src/ndn-ind/src/encrypt/schedule.cpp \
  src/ndn-ind/src/encrypt/sqlite3-consumer-db.cpp \
  src/ndn-ind/src/encrypt/sqlite3-group-manager-db.cpp \
  src/ndn-ind/src/encrypt/sqlite3-producer-db.cpp \
  src/ndn-ind/src/encrypt/algo/aes-algorithm.cpp \
  src/ndn-ind/src/encrypt/algo/encrypt-params.cpp \
  src/ndn-ind/src/encrypt/algo/encryptor.cpp \
  src/ndn-ind/src/encrypt/algo/rsa-algorithm.cpp \
  src/ndn-ind/src/impl/delayed-call-table.cpp \
  src/ndn-ind/src/impl/interest-filter-table.cpp \
  src/ndn-ind/src/impl/pending-interest-table.cpp \
  src/ndn-ind/src/impl/registered-prefix-table.cpp \
  src/ndn-ind/src/in-memory-storage/in-memory-storage-retaining.cpp \
  src/ndn-ind/src/lite/control-parameters-lite.cpp \
  src/ndn-ind/src/lite/control-response-lite.cpp \
  src/ndn-ind/src/lite/data-lite.cpp \
  src/ndn-ind/src/lite/delegation-set-lite.cpp \
  src/ndn-ind/src/lite/exclude-lite.cpp \
  src/ndn-ind/src/lite/interest-lite.cpp \
  src/ndn-ind/src/lite/key-locator-lite.cpp \
  src/ndn-ind/src/lite/meta-info-lite.cpp \
  src/ndn-ind/src/lite/name-lite.cpp \
  src/ndn-ind/src/lite/network-nack-lite.cpp \
  src/ndn-ind/src/lite/registration-options-lite.cpp \
  src/ndn-ind/src/lite/signature-lite.cpp \
  src/ndn-ind/src/lite/encoding/element-listener-lite.cpp \
  src/ndn-ind/src/lite/encoding/tlv-0_2-wire-format-lite.cpp \
  src/ndn-ind/src/lite/encrypt/encrypted-content-lite.cpp \
  src/ndn-ind/src/lite/encrypt/algo/aes-algorithm-lite.cpp \
  src/ndn-ind/src/lite/encrypt/algo/des-algorithm-lite.cpp \
  src/ndn-ind/src/lite/encrypt/algo/encrypt-params-lite.cpp \
  src/ndn-ind/src/lite/lp/congestion-mark-lite.cpp \
  src/ndn-ind/src/lite/lp/incoming-face-id-lite.cpp \
  src/ndn-ind/src/lite/lp/lp-packet-lite.cpp \
  src/ndn-ind/src/lite/security/ec-private-key-lite.cpp \
  src/ndn-ind/src/lite/security/ec-public-key-lite.cpp \
  src/ndn-ind/src/lite/security/rsa-private-key-lite.cpp \
  src/ndn-ind/src/lite/security/rsa-public-key-lite.cpp \
  src/ndn-ind/src/lite/security/validity-period-lite.cpp \
  src/ndn-ind/src/lite/transport/tcp-transport-lite.cpp \
  src/ndn-ind/src/lite/transport/udp-transport-lite.cpp \
  src/ndn-ind/src/lite/util/blob-lite.cpp \
  src/ndn-ind/src/lite/util/crypto-lite.cpp \
  src/ndn-ind/src/lite/util/dynamic-malloc-uint8-array-lite.cpp \
  src/ndn-ind/src/lite/util/dynamic-uint8-array-lite.cpp \
  src/ndn-ind/src/lp/congestion-mark.cpp \
  src/ndn-ind/src/lp/incoming-face-id.cpp \
  src/ndn-ind/src/lp/lp-packet.cpp \
  src/ndn-ind/src/security/command-interest-preparer.cpp \
  src/ndn-ind/src/security/command-interest-signer.cpp \
  src/ndn-ind/src/security/key-chain.cpp \
  src/ndn-ind/src/security/key-params.cpp \
  src/ndn-ind/src/security/safe-bag.cpp \
  src/ndn-ind/src/security/security-exception.cpp \
  src/ndn-ind/src/security/signing-info.cpp \
  src/ndn-ind/src/security/validator-null.cpp \
  src/ndn-ind/src/security/validity-period.cpp \
  src/ndn-ind/src/security/verification-helpers.cpp \
  src/ndn-ind/src/security/certificate/certificate-extension.cpp \
  src/ndn-ind/src/security/certificate/certificate-subject-description.cpp \
  src/ndn-ind/src/security/certificate/certificate.cpp \
  src/ndn-ind/src/security/certificate/identity-certificate.cpp \
  src/ndn-ind/src/security/certificate/public-key.cpp \
  src/ndn-ind/src/security/identity/basic-identity-storage.cpp \
  src/ndn-ind/src/security/identity/file-private-key-storage.cpp \
  src/ndn-ind/src/security/identity/identity-manager.cpp \
  src/ndn-ind/src/security/identity/identity-storage.cpp \
  src/ndn-ind/src/security/identity/memory-identity-storage.cpp \
  src/ndn-ind/src/security/identity/memory-private-key-storage.cpp \
  src/ndn-ind/src/security/identity/private-key-storage.cpp \
  src/ndn-ind/src/security/pib/pib-certificate-container.cpp \
  src/ndn-ind/src/security/pib/pib-identity-container.cpp \
  src/ndn-ind/src/security/pib/pib-identity.cpp \
  src/ndn-ind/src/security/pib/pib-key-container.cpp \
  src/ndn-ind/src/security/pib/pib-key.cpp \
  src/ndn-ind/src/security/pib/pib-memory.cpp \
  src/ndn-ind/src/security/pib/pib-sqlite3.cpp \
  src/ndn-ind/src/security/pib/pib.cpp \
  src/ndn-ind/src/security/pib/detail/pib-identity-impl.cpp \
  src/ndn-ind/src/security/pib/detail/pib-key-impl.cpp \
  src/ndn-ind/src/security/policy/config-policy-manager.cpp \
  src/ndn-ind/src/security/policy/no-verify-policy-manager.cpp \
  src/ndn-ind/src/security/policy/policy-manager.cpp \
  src/ndn-ind/src/security/policy/self-verify-policy-manager.cpp \
  src/ndn-ind/src/security/tpm/tpm-back-end-file.cpp \
  src/ndn-ind/src/security/tpm/tpm-back-end-memory.cpp \
  src/ndn-ind/src/security/tpm/tpm-back-end-osx.cpp \
  src/ndn-ind/src/security/tpm/tpm-back-end.cpp \
  src/ndn-ind/src/security/tpm/tpm-key-handle-memory.cpp \
  src/ndn-ind/src/security/tpm/tpm-key-handle-osx.cpp \
  src/ndn-ind/src/security/tpm/tpm-key-handle.cpp \
  src/ndn-ind/src/security/tpm/tpm-private-key.cpp \
  src/ndn-ind/src/security/tpm/tpm.cpp \
  src/ndn-ind/src/security/v2/certificate-cache-v2.cpp \
  src/ndn-ind/src/security/v2/certificate-fetcher-from-network.cpp \
  src/ndn-ind/src/security/v2/certificate-fetcher-offline.cpp \
  src/ndn-ind/src/security/v2/certificate-fetcher.cpp \
  src/ndn-ind/src/security/v2/certificate-storage.cpp \
  src/ndn-ind/src/security/v2/certificate-v2.cpp \
  src/ndn-ind/src/security/v2/trust-anchor-container.cpp \
  src/ndn-ind/src/security/v2/trust-anchor-group.cpp \
  src/ndn-ind/src/security/v2/validation-error.cpp \
  src/ndn-ind/src/security/v2/validation-policy-accept-all.cpp \
  src/ndn-ind/src/security/v2/validation-policy-command-interest.cpp \
  src/ndn-ind/src/security/v2/validation-policy-config.cpp \
  src/ndn-ind/src/security/v2/validation-policy-from-pib.cpp \
  src/ndn-ind/src/security/v2/validation-policy-simple-hierarchy.cpp \
  src/ndn-ind/src/security/v2/validation-policy.cpp \
  src/ndn-ind/src/security/v2/validation-state.cpp \
  src/ndn-ind/src/security/v2/validator.cpp \
  src/ndn-ind/src/security/v2/validator-config/config-checker.cpp \
  src/ndn-ind/src/security/v2/validator-config/config-filter.cpp \
  src/ndn-ind/src/security/v2/validator-config/config-name-relation.cpp \
  src/ndn-ind/src/security/v2/validator-config/config-rule.cpp \
  src/ndn-ind/src/transport/async-tcp-transport.cpp \
  src/ndn-ind/src/transport/async-unix-transport.cpp \
  src/ndn-ind/src/transport/tcp-transport.cpp \
  src/ndn-ind/src/transport/transport.cpp \
  src/ndn-ind/src/transport/udp-transport.cpp \
  src/ndn-ind/src/transport/unix-transport.cpp \
  src/ndn-ind/src/util/boost-info-parser.cpp \
  src/ndn-ind/src/util/command-interest-generator.cpp \
  src/ndn-ind/src/util/config-file.cpp \
  src/ndn-ind/src/util/dynamic-uint8-vector.cpp \
  src/ndn-ind/src/util/exponential-re-express.cpp \
  src/ndn-ind/src/util/logging.cpp \
  src/ndn-ind/src/util/memory-content-cache.cpp \
  src/ndn-ind/src/util/segment-fetcher.cpp \
  src/ndn-ind/src/util/sqlite3-statement.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-backref-manager.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-backref-matcher.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-component-matcher.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-component-set-matcher.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-matcher-base.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-pattern-list-matcher.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-pseudo-matcher.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-repeat-matcher.cpp \
  src/ndn-ind/src/util/regex/ndn-regex-top-matcher.cpp
include $(BUILD_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := ndn-example
LOCAL_LDLIBS := -llog -lm -latomic
LOCAL_SHARED_LIBRARIES := ndn-ind
LOCAL_CFALGS := -O3 -UNDEBUG
LOCAL_C_INCLUDES := \
  $(LOCAL_PATH)/src/ndn-ind/include
LOCAL_SRC_FILES := \
  src/ndn-ind/examples/test-encode-decode-data.cpp
