...
/**
 * A Tlv0_1_1WireFormatLite extends Tlv0_2WireFormatLite so that it is an alias
 * in case any applications use Tlv0_1_1WireFormatLite directly.  These two wire
