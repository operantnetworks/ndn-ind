 ...
 *
 * Original file: src/c/encrypt/algo/des-algorithm_c.c
   ...
   size_t encryptedDataLength, uint8_t *plainData, size_t *plainDataLength)
{
  ...
  if (keyLength != ndn_DES_EDE3_KEY_LENGTH)
    return NDN_ERROR_Incorrect_key_size;
  if (initialVectorLength != ndn_DES_BLOCK_LENGTH)
  ...
  EVP_DecryptInit
    (ctx, EVP_des_ede3_cbc(), (const unsigned char*)key,
