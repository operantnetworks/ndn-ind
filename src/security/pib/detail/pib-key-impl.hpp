 ...
 *
 * Original file: src/security/pib/detail/pib-key-impl.hpp
 ...
 * @author: From ndn-cxx security https://github.com/named-data/ndn-cxx/blob/master/ndn-cxx/security/pib/detail/key-impl.hpp
 *
