 ...
 *
 * Original file: src/security/v2/validation-policy.cpp
 ...
 * @author: From ndn-cxx security https://github.com/named-data/ndn-cxx/blob/master/ndn-cxx/security/v2/validation-policy.cpp
 *
