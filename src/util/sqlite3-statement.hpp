 ...
 *
 * Original file: src/util/sqlite3-statement.hpp
 ...
 * @author: From ndn-cxx security https://github.com/named-data/ndn-cxx/blob/master/ndn-cxx/util/sqlite3-statement.hpp
 *
